...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/users/{id}").hasRole("BLOGGER")
                .antMatchers(HttpMethod.PUT, "/api/users/{id}").hasRole("BLOGGER")
                .antMatchers(HttpMethod.DELETE, "/api/users{id}").hasRole("BLOGGER")
                .and()
                .formLogin()
                .permitAll()
